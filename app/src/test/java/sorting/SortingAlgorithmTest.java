...
public abstract class SortingAlgorithmTest {
    ...
    /**
     * This abstract method forces all child test classes to provide 
     * the specific sorting algorithm they want to test.
     */
    protected abstract SortingAlgorithm specifySorter();

    @BeforeEach
    public void setUp() {
        // We get the specific sorter from the child class before each test
        sorter = specifySorter();
    }
